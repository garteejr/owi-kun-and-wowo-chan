  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-[#fdfef9] via-[#f6fbef] to-[#eef7e2] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-12 px-6 py-20 sm:px-10 lg:px-16 min-h-screen">
        ...
        {/* ILLUSTRATION - atas di mobile, kanan di desktop */}
        ...
        {/* TEXT - bawah di mobile, kiri di desktop */}
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left order-last lg:order-first">
      ...
      <style jsx>{`
        ...
        .animate-gradientMove { animation: gradientMove 5s ease infinite; }
